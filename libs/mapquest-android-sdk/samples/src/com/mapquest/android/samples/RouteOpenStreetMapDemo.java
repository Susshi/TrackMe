...
/**
 * This class demonstrates using the OpenStreetMap data to create a route
 */
public class RouteOpenStreetMapDemo extends SimpleMap{
	
	@Override
	protected int getLayoutId() {
		return R.layout.route_osm_demo;
	}
	...
	protected void init() {
		...
		//grab refs to UI elements we need
